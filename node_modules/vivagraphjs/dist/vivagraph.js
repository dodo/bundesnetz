...
},{"ngraph.physics.simulator":9}],9:[function(require,module,exports){
/**
...
},{"./lib/bounds":10,"./lib/createBody":11,"./lib/dragForce":12,"./lib/eulerIntegrator":13,"./lib/spring":14,"./lib/springForce":15,"ngraph.expose":16,"ngraph.merge":25,"ngraph.quadtreebh":18}],10:[function(require,module,exports){
...
},{"ngraph.random":26}],11:[function(require,module,exports){
...
},{"ngraph.physics.primitives":17}],12:[function(require,module,exports){
/**
...
},{"ngraph.expose":16,"ngraph.merge":25}],13:[function(require,module,exports){
/**
...
},{"ngraph.expose":16,"ngraph.merge":25,"ngraph.random":26}],16:[function(require,module,exports){
...
},{"./insertStack":19,"./isSamePosition":20,"./node":21,"ngraph.random":26}],19:[function(require,module,exports){
...
},{"ngraph.events":7}],25:[function(require,module,exports){
...
},{"ngraph.centrality":4}],34:[function(require,module,exports){
/**
...
},{"ngraph.events":7}],40:[function(require,module,exports){
...
function renderer(graph, settings) {
  ...
  function updateCenter() {
    ...
    if (containerSize.width < 1 || containerSize.height < 1 || !layout.getGraphRect) {
      return;
    }
...
},{"../Input/domInputManager.js":35,"../Input/dragndrop.js":36,"../Utils/getDimensions.js":43,"../Utils/timer.js":47,"../Utils/windowEvents.js":48,"./svgGraphics.js":50,"ngraph.events":7,"ngraph.forcelayout":8}],50:[function(require,module,exports){
/**
...
},{"../Input/domInputManager.js":35,"ngraph.events":7,"simplesvg":28}],51:[function(require,module,exports){
/**
...
},{"../Input/webglInputManager.js":37,"../WebGL/webglLine.js":59,"../WebGL/webglLinkProgram.js":60,"../WebGL/webglNodeProgram.js":61,"../WebGL/webglSquare.js":62,"ngraph.events":7,"ngraph.merge":25}],52:[function(require,module,exports){
...
function webglInputEvents(webglGraphics) {
  ...
  function preciseCheck(nodeUI, x, y) {
    if (nodeUI && nodeUI.width && nodeUI.height) {
      var pos = nodeUI.position,
        halfh = nodeUI.height * 0.5;
        halfw = nodeUI.width * 0.5;

      return pos.x - halfw < x && x < pos.x + halfw &&
        pos.y - halfh < y && y < pos.y + halfh;
    } else if (nodeUI && nodeUI.size) {
      var pos = nodeUI.position,
        half = nodeUI.size;
...
},{"./texture.js":53,"./webgl.js":54,"font-atlas":2}],65:[function(require,module,exports){
